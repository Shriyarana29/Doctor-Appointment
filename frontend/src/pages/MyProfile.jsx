        ...
        <img className='w-36 rounded' src={userData.image} alt='' />
        {
          isEdit
            ? <input className='bg-gray-50 text-3xl font-medium max-w-60 mt-4'
              type='text' value={userData.name} onChange={e => setUserData(prev => ({
                ...prev,
                name: e.target.value
              }))}></input>
            ...
            <p className='font-medium'>Phone: </p>
            {
              isEdit
                ? <input className='bg-gray-100 max-w-52'
                  type='text' value={userData.phone} onChange={e => setUserData(prev => ({ ...prev, phone: e.target.value }))}></input>
              ...
              isEdit
                ? <p>
                  <input className='bg-gray-50'
                    e value={userData.address.line1} onChange={(e) => setUserData(prev => ({ ...prev, address, line1: e.target.value }))} type='text' />
                  <br />
                  <input className='bg-gray-50'
                    value={userData.address.line2} onChange={(e) => setUserData(prev => ({ ...prev, address, line2: e.target.value }))} type='text' />
                </p>
                : <p>
